...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/admin/fontawesome-stars.css')}}">
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2017 <a href="javascript:void(0);">Gaurav Deshpande</a>
            </div>
        </div>
        <!-- #Footer -->
    </aside>
...
<!-- Rating bar -->
<script src="{{url('js/admin/plugins/jquery.barrating.min.js')}}"></script>
